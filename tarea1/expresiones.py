...
ejercicios = {
    "e01": re.compile(r'^[a-z]([aeiou][a-z])*$')
}

pruebas_match = {
    "e01": ["a", "bac", "holas", "xexix", "mural"]
}
...
ejercicios = {
    "e10": re.compile(r'^([b-df-hj-np-tv-z0-9]*|[a-z0-9]*[b-df-hj-np-tv-z][a-z0-9]*[b-df-hj-np-tv-z][a-z0-9]*)$')
}

pruebas_match = {
    "e10": ["123", "bcd", "hola", "xaeiouy", "dcd"]
}

pruebas_nmatch = {
    "e10": ["a", "aeiou", "ba", "e123", "a1b2"]
}
...
ejercicios = {
    "e22": re.compile(r'^[a-z0-9]*([a-z][a-z0-9]*[0-9]|[0-9][a-z0-9]*[a-z])[a-z0-9]*$')
}

pruebas_match = {
    "e22": ["a1", "1a", "hola123", "000x000", "a1b2c3"]
}
